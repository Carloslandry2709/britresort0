    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            {['experience', 'hebergements', 'evenements', 'contact'].map((item, index) => (
              <motion.button 
                key={item}
                ...
                className="text-sm font-medium tracking-widest text-foreground/80 hover:text-primary transition-colors duration-300 underline-animated uppercase"
              >
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.button
          ...
          className="absolute bottom-10 left-1/2 -translate-x-1/2 text-foreground/60 hover:text-primary transition-colors animate-float"
        >
      ...
      <section id="about" className="py-28 md:py-40 bg-background relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.span 
              variants={fadeInUp}
              className="inline-block text-primary text-sm md:text-base tracking-[0.4em] uppercase font-body font-medium mb-4"
            >
              Bienvenue
            </motion.span>
            <motion.h2 
              variants={fadeInUp}
              className="font-display text-4xl md:text-6xl lg:text-7xl font-light text-foreground mb-8 leading-tight"
            >
            ...
            <motion.p 
              variants={fadeInUp}
              className="font-body text-lg md:text-xl text-muted-foreground leading-relaxed mb-16 max-w-3xl mx-auto"
            >
          ...
          >
            {[
              ...
              <motion.div
                ...
                whileHover="hover"
                animate="rest"
                className={`group relative overflow-hidden cursor-pointer ${index === 3 || index === 4 ? 'lg:col-span-1' : ''} ${index === 4 ? 'md:col-span-2 lg:col-span-1' : ''}`}
              >
                <motion.div 
                  variants={cardHover}
      ...
      <section id="hebergements" className="py-28 md:py-40 bg-background relative">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p 
              variants={fadeInUp}
              className="text-muted-foreground font-body text-lg md:text-xl max-w-3xl mx-auto leading-relaxed"
            >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="btn-luxury-filled inline-flex"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              <motion.div 
                variants={fadeInUp}
                className="flex items-center gap-3 text-muted-foreground font-body text-base"
              >
      ...
      <section id="contact" className="py-28 md:py-40 bg-muted/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p 
              variants={fadeInUp}
              className="font-body text-lg md:text-xl text-muted-foreground mb-14 leading-relaxed"
            >
            ...
            >
              <motion.a 
                ...
                whileTap={{ scale: 0.98 }}
                href={`tel:${phoneNumber}`} 
                className="btn-luxury-filled w-full sm:w-auto animate-pulse-glow"
              >
                <Phone className="w-5 h-5" />
                +225 07 11 11 94 94
              </motion.a>
            ...
            <motion.div 
              variants={scaleIn}
              className="inline-block px-8 py-4 border border-primary/30 bg-primary/5 animate-border-glow"
            >
          ...
          >
            ...
            <motion.div variants={fadeInRight} className="text-center md:text-right">
              ...
              <div className="flex justify-center md:justify-end gap-4">
                {['FB', 'IG'].map((social, index) => (
                  <motion.a 
                    key={social}
                    whileHover={{ scale: 1.1, y: -3 }}
                    href="#" 
                    className="w-12 h-12 border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors duration-300"
                  >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        href={`tel:${phoneNumber}`}
        className="fixed bottom-6 left-6 z-50 w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-lg hover:bg-primary/90 transition-colors md:hidden glow-gold"
      >
